  ...
  themeConfig: {
    ...
    sidebar: [{
      ...
      items: [      
        ...
        { text: 'Deshabilitar/Pausar Consultas', link: '/guides-and-concepts/disabling-queries' },
        { text: 'Reintentos de Consulta', link: '/guides-and-concepts/query-retries' },
        { text: 'Consultas Paginadas/Rezagadas', link: '/guides-and-concepts/paginated-queries' },         
